...
The Phishing Unfolding case study displays all 65 scenario screenshots and one later file-analysis screenshot inline, with evidence placed under each alert. The [screenshot index](evidence/phishing-unfolding/README.md) also provides timestamp-based navigation.
